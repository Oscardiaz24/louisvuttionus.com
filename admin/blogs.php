										...
										<div class="card-body">
											...
											<div class="row">
												<div class="col-md-6 col-6">
													<a href="update_blog.php?id=<?php  echo $rec['id']; ?>" class="btn btn-outline-primary w-100">Edit</a>
												</div>
												<div class="col-md-6 col-6">
													<a href="action.php?del_blog=<?php  echo $rec['id']; ?>" class="btn btn-outline-danger w-100">Trash</a>
												</div>
											</div>
										</div>
									</div>
