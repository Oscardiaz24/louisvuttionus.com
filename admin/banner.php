		...
		<div class="row">
			<div class="col-xl-12">
				...
				<div class="card">
					<div class="row p-3">
						<div class="col-md-6">
							<h2 class="p-3">Banner</h2>
						</div>
						<div class="col-md-6 text-right">
							<a href="add_banner.php" class="btn btn-outline-success">Add Banner</a>
						</div>
					</div>
										...
										<div class="card-body">
											...
											<div class="row">
												<div class="col-md-6 col-6">
													<a href="update_banner.php?id=<?php  echo $rec['id']; ?>" class="btn btn-outline-primary w-100">Edit</a>
												</div>
												<div class="col-md-6 col-6">
													<a href="action.php?del_banner=<?php  echo $rec['id']; ?>" class="btn btn-outline-danger w-100">Trash</a>
												</div>
											</div>
										</div>
									</div>
