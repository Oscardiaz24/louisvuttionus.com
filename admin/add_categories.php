		...
		<div class="row">
			<div class="col-xl-12">
				...
				<div class="card">
					<div class="row p-3">
						<div class="col-md-6">
							<h2 class="p-3">Add Categories</h2>
						</div>
					</div>
					...
					<div class="row m-2">
						<div class="col-md-12">
							<form method="POST" action="action.php" enctype="multipart/form-data">
								<label>Name</label>
								<input type="text" class="form-control" placeholder="Enter Your Name" name="heading" required>
								...
								<div class="row mt-3">
									<div class="col-md-3 mx-auto">
										<button type="submit" class="btn btn-outline-success w-100" name="add_categories">Submit</button>
									</div>
								</div>
							</form>
						</div>
