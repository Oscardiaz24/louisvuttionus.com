					...
					<div class="row m-2">
						<div class="col-md-12">
							<form method="POST" action="action.php" enctype="multipart/form-data">
								<label>Heading</label>
								<input type="text" class="form-control" placeholder="Enter Your Heading" name="heading" value="<?php  echo $banner['heading']; ?>">
								...
								<div class="row mt-3">
									<div class="col-md-3 mx-auto">
										<button type="submit" name="update_banner" class="btn btn-outline-success w-100" >Update</button>
									</div>
								</div>
							</form>
						</div>
